...
```{r tableDwCterms, eval = knitr::is_latex_output(), echo = FALSE, out.width = '100%'}

knitr::include_graphics("conditional_blocks/DwC-term-table-vertical.pdf")

```

```{r eval=knitr::is_html_output(), echo = FALSE, child="DwC-terms-table.md"}
```
