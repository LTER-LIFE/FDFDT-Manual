...
```{r budburst, echo = FALSE, out.width = '50%', fig.cap = 'FAIR assessment of bud burst data. Striped circles indicate the hypothetical status of the dataset once it is stored in a repository (see note box above).', fig.align = 'center', fig.pos= "H", dev = 'svg'}

knitr::include_graphics(
  if (knitr::is_latex_output()) {
    "images/ID-card_budburst.pdf"
  } else {
    "images/ID-card_budburst.svg"
  }
)
...
```{r crickets, echo = FALSE, out.width = '50%', fig.cap = 'FAIR assessment of cricket data. Striped circles indicate the hypothetical status of the dataset once it is stored in a repository (see note box above).', fig.align = 'center', fig.pos= "H", dev = 'svg'}

knitr::include_graphics(
  if (knitr::is_latex_output()) {
    "images/ID-card_cricket.pdf"
  } else {
    "images/ID-card_cricket.svg"
  }
)
...
knitr::include_graphics(
  if (knitr::is_latex_output()) {
    "images/ID-card_CLUE.pdf"
  } else {
    "images/ID-card_CLUE.svg"
  }
)
