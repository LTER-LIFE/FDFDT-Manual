...
```{r budburst, echo = FALSE, out.width = '50%', fig.cap = 'FAIR assessment of bud burst data. Striped cicrles indicate the hypothetical status of the dataset once it is stored on a repository (see note box above).', fig.align = 'center', dev = 'svg'}
...
```{r crickets, echo = FALSE, out.width = '50%', fig.cap = 'FAIR assessment of cricket data. Striped cicrles indicate the hypothetical status of the dataset once it is stored on a repository (see note box above).', fig.align = 'center', dev = 'svg'}
...
```{r CLUE, echo = FALSE, out.width = '50%', fig.cap = 'FAIR assessment of CLUE data. Striped cicrles indicate the hypothetical status of the dataset once it is stored on a repository (see note box above).', fig.align = 'center', dev = 'svg'}
