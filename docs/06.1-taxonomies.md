...
Some contents or entities in your data might also be mentioned in another source or other sources might contain related entities. To provide context to your data and to properly embed the data into related resources, your data should refer to these by cross-referencing, for example, their unique identifier. Identifiers for the same entity or concepts are likely different in different resources and therefore the different identifiers should be mapped to one another. There are different ways of doing this and a more detailed description of these mapping methods can be found [here](https://faircookbook.elixir-europe.org/content/recipes/interoperability/identifier-mapping.html).
