...
\caption{**Each of the FAIR principles (grey boxes) can directly be linked to one or more of the questions of our evaluation tool (coloured boxes, pink for metadata, blue for storage, green for standards).** The questions about structure are missing, as they are not directly derived from the FAIR principles.}(\#fig:Fig-mapping)
\end{figure}
