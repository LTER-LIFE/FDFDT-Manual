...
The general workflow of making your data more [FAIR](#FAIR) and structured is shown in Figure 3.1 and shortly described in the following section.
...
<div class="figure">
<img src="images/workflow.svg" alt="**Diagram of the workflow presented in this guide to FAIRify data.** The colours refer to the data properties introduced in this guide (metadata = red, storage = blue, standards = green, structure  = orange)." width="100%" />
<p class="caption">(\#fig:workflow-html)**Diagram of the workflow presented in this guide to FAIRify data.** The colours refer to the data properties introduced in this guide (metadata = red, storage = blue, standards = green, structure  = orange).</p>
</div>
