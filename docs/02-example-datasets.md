...
<img src="images/ID-card_budburst.svg" alt="FAIR assessment of bud burst data. Striped circles indicate the hypothetical status of the dataset once it is stored in a repository (see note box above)." width="50%" />
<p class="caption">(\#fig:budburst)FAIR assessment of bud burst data. Striped circles indicate the hypothetical status of the dataset once it is stored in a repository (see note box above).</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/ID-card_cricket.svg" alt="FAIR assessment of cricket data. Striped circles indicate the hypothetical status of the dataset once it is stored in a repository (see note box above)." width="50%" />
<p class="caption">(\#fig:crickets)FAIR assessment of cricket data. Striped circles indicate the hypothetical status of the dataset once it is stored in a repository (see note box above).</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/ID-card_CLUE.svg" alt="FAIR assessment of CLUE data. Striped circles indicate the hypothetical status of the dataset once it is stored in a repository (see note box above)." width="50%" />
<p class="caption">(\#fig:CLUE)FAIR assessment of CLUE data. Striped circles indicate the hypothetical status of the dataset once it is stored in a repository (see note box above).</p>
</div>
