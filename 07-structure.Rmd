...
```{r relational-database-html, eval = knitr::is_html_output(), echo = FALSE, out.width = '100%', fig.cap = '**Relational database structure of Darwin Core files.** Arrows refer to the identifier through which two files are linked.', dev = 'svg'}

knitr::include_graphics("images/DwC-relationalDatabase.svg")

```

```{r relational-database-pdf, eval = knitr::is_latex_output(), echo = FALSE, out.width = '100%', fig.cap = 'Relational database structure of Darwin Core files. Arrows refer to the identifier through which two files are linked.'}

knitr::include_graphics("images/DwC-relationalDatabase.pdf")
...
```{r star-schema-html, eval = knitr::is_html_output(),echo = FALSE, out.width = '80%', fig.cap = '**Schematic of Darwin Core Archive.** The data is structured into a core file and sourrounded by extension files in a star shaped manner. The data is accompanied by two metadata files. ', fig.align = 'center', dev = 'svg'}

knitr::include_graphics("images/star-schema.svg")

```

```{r star-schema-pdf, eval = knitr::is_latex_output(), echo = FALSE, out.width = '80%', fig.cap = 'Schematic of Darwin Core Archive. The data is structured into a core file and sourrounded by extension files in a star shaped manner. The data is accompanied by two metadata files. ', fig.align = 'center'}

knitr::include_graphics("images/star-schema.pdf")
