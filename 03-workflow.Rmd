...
```{r workflow, echo = FALSE, out.width = '100%', fig.cap = 'Diagram of the workflow presented in this guide to FAIRify data.'}

knitr::include_graphics("images/workflow_diagramm.png")
