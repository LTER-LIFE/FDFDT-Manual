...
```{r workflow-html, eval = knitr::is_html_output(), echo = FALSE, out.width = '100%', fig.cap = '**Diagram of the workflow presented in this guide to FAIRify data.** The colours refer to the data properties introduced in this guide (metadata = red, storage = blue, standards = green, structure  = orange).', dev = "svg"}

knitr::include_graphics("images/workflow.svg")

```

```{r workflow-latex, eval = knitr::is_latex_output(), echo = FALSE, out.width = '100%', fig.cap = 'Diagram of the workflow presented in this guide to FAIRify data. The colours refer to the data properties introduced in this guide (metadata = red, storage = blue, standards = green, structure  = orange).'}

knitr::include_graphics("images/workflow.pdf")
