...
```{r eval=knitr::is_latex_output(), echo = FALSE, child="conditional_blocks/EML-ID-example-latex.md"}
```   

```{r eval=knitr::is_html_output(), echo = FALSE, child="conditional_blocks/EML-ID-example-html.md"}
```
