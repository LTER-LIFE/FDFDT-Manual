...
```{r FAIR-html, fig.align='center', fig.cap= "**The FAIR concept.** The four letters of FAIR stand for findable, accessible, interoperable and reusable and come with 15 guiding principles.", echo = FALSE, out.width = '100%', dev= 'svg', eval = knitr::is_html_output()}

knitr::include_graphics("images/Figure1.svg")

```

```{r FAIR-latex, fig.align='center', fig.cap= "The FAIR concept. The four letters of FAIR stand for findable, accessible, interoperable and reusable and come with 15 guiding principles.", echo = FALSE, out.width = '100%', eval = knitr::is_latex_output()}
